...
syscall_t syscall_table[] =
{
    ...
    {179, "quotactl", 4},
    {180, "nfsservctl", 3},
    {181, "getpmsg", 0}, // Unimplemented
    {182, "putmsg", 0}, // Unimplemented
    {183, "afs_stscall", 0}, // Unimplemented
    {184, "tuxcall", 0}, // Unimplemented
    {185, "security", 0}, // Unimplemented
    {186, "gettid", 0},
    {187, "readahead", 3},
    {188, "setxattr", 5},
    {189, "lsetxattr", 5},
    ...
    {305, "clock_adjtime", 0}, // Pas de man
    {307, "syncfs", 1},
    {308, "setns", 2},
    {309, "getcpu", 3},
    ...
    {331, "pkey_free", 1},
    {332, "statx", 5},
    {333, "io_pgetevents", 0}, // Pas de man
    {334, "rseq", 0}, // Pas de man
};
